            ...
            <div class="col-md-12">
                ...
                <form action="{{ url('store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="question" id="question" class="form-control" style="width:100%" required>
                    </div>
                    <div class="form-group">
                        <label for="answer_1">Answer 1</label>
                        <input type="text" name="answers[1]" id="answer_1" class="form-control" style="width:100%" required>
                        <select name="result_answer[1]" class="form-control" style="width:100%">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="answers[2]" id="answer_2" class="form-control" style="width:100%" required>
                        <select name="result_answer[2]" class="form-control" style="width:100%">
                            @foreach($result_parameters as $item)
                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                            @endforeach
                        </select>
